...
import { fetchAnalytics, fetchRequests, generateFuzz, purgeAll, exportProject, importProject, getOptions, setOptions } from './api.js'
  ...
  return (
    <div className="app-root">
      ...
      <div className="content">
        ...
        <div className="right">
          <AnalyticsPanels analytics={analytics} selectedHost={selectedHost} onSelectHost={setSelectedHost} selectedTech={selectedTech} onSelectTech={setSelectedTech} />
        </div>
      </div>
      <OptionsPanel
        open={showOptions}
